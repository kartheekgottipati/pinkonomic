...
// Define Game type with platform type
interface Game {
  name: string;
  tagline: string;
  image: string | null;
...
// Game Data with platform information
const games: Game[] = [
	{
		name: "Pink Drop",
		tagline: "Merge parachains, climb the leaderboard!",
		image: pinkDropPreview,
		link: "/pinkiverse/pinkdrop", // Link to details page
		featured: true,
		playLink: "/pinkdrop", // Direct link to game
		platform: "browser"
	},
	{
...
const Pinkiverse = () => {
	return (
		<section className="relative min-h-screen flex flex-col items-center text-white py-12 px-4 md:px-8 lg:px-12 bg-black overflow-hidden">
			...
			{/* Animated Particles (subtle pink dots) */}
			...
			<div className="w-full max-w-7xl px-4">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
					{/* Show ALL games including placeholder/coming soon games */}
...
// Helper function to get platform-specific button text
...
const FeaturedGameCard = ({ game }: { game: Game }) => (
  ...
  >
    ...
    <div className="relative flex-grow p-5 flex flex-col justify-between">
      ...
      {/* Action Buttons - Fixed Width and Layout */}
      <div className="grid grid-cols-2 gap-3">
        {/* Play Button - Replace gradient with solid color */}
	...
	>
		...
		<div className="p-5 flex-grow flex flex-col justify-between">
			...
			<div className="mt-4 flex flex-col gap-2">
				{/* Play Now Button - Replace gradient with solid color */}
				{game.playLink && game.platform !== "coming-soon" && (
				...
				{/* Details Link - Only if a link exists */}
				{game.link ? (
					<motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
						<Link
							to={game.link}

...
const GamePage = ({ title, description, image, platforms, playLinks, tournaments }: GamePageProps) => {
  ...
  useEffect(() => {
    // Simulate loading delay for dramatic reveal
    const timer = setTimeout(() => setIsLoaded(true), 500);
    return () => clearTimeout(timer);
  }, []);

  // Generate a cooler game slogan based on the title
  ...
  return (
    <div className="relative bg-black min-h-screen text-white overflow-hidden" ref={mainRef}>
      ...
      <div className="relative h-screen overflow-hidden">
        {/* Parallax background image with improved visibility */}
        <motion.div 
        ...
        {/* Center Content with better contrast for readability */}
        <motion.div 
          className="absolute inset-0 flex items-center justify-center px-4 z-30"
          style={{ y: textY, opacity }}
        >
          <div className="text-center max-w-5xl mx-auto">
            {/* Game Title with shadow for better readability */}
            <motion.div
      ...
      <div className="relative bg-gradient-to-b from-black via-gray-950/95 to-black min-h-screen">
        {/* Platform Badges - Floating at top of content */}
                    ...
                    {tournament.link && !isPast && (
                      ...
                      >
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`inline-flex items-center px-5 py-2 rounded-lg font-medium whitespace-nowrap ${
                            isActive 

...
const Hero = forwardRef<HTMLDivElement>((props, ref) => (
  ...
  >
    ...
    {/* Enhanced circular glow effect behind platypus */}
    ...
    <div className="container mx-auto px-6 py-12 relative z-10">
      <div className="flex flex-col-reverse lg:flex-row items-center gap-10">
        ...
        >
          ...
          {/* Description with more polished styling */}
          ...
          {/* Enhanced feature cards with rounded corners */}
        ...
        {/* Image side - enhanced with meme coin vibes */}
        <motion.div 
        ...
        >
          <div className="relative">
            {/* Crypto-inspired coin container with meme aesthetics */}
            <div className="relative w-[400px] h-[400px] md:w-[520px] md:h-[520px] rounded-full bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center border-[3px] border-pink-500/40 shadow-[0_0_60px_rgba(236,72,153,0.25)] overflow-hidden">
              ...
              {/* "$PINK" text element orbiting in the opposite direction */}
              <motion.div
              ...
              {/* PINK logo with enhanced 3D animation */}
              <motion.div
                animate={{ 
                  rotateY: [-5, 5, -5],
                  rotateX: [3, -3, 3],
              ...
              {/* Blockchain rings rotating around the logo */}
              {[...Array(3)].map((_, i) => (
                <motion.div 
                  key={`ring-${i}`}
              ...
              {/* Enhanced orbiting dots with glow and varied animations */}
            ...
            {/* Meme-style starburst behind the coin */}
